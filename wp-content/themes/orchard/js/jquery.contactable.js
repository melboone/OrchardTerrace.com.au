	...
	jQuery.fn.contactable = function(options) {
		...
		return this.each(function() {
			...
			*/
			...
			jQuery(this).html('<div id="contactable-inner"></div><form id="contactable-contactForm" method="" action=""><div id="contactable-loading"></div><div id="contactable-callback"></div><div class="contactable-holder"><p><label for="contactable-name">'+options.name+'<span class="contactable-green"> </span></label><br /><input placeholder="NAME" id="contactable-name" class="contactable-contact contactable-validate" name="name" /></p><p><label for="contactable-email">'+options.email+' <span class="contactable-green"> </span></label><br /><input placeholder="EMAIL" id="contactable-email" class="contactable-contact contactable-validate" name="email" /></p>'+dropdown+'<p><label for="contactable-message">'+options.message+' <span class="contactable-green"> </span></label><br /><input placeholder="PHONE" id="contactable-message" name="message" class="contactable-message contactable-validate" ></input></p><p><input class="contactable-submit" type="submit" value="'+options.submit+'"/></p><p class="contactable-disclaimer">'+options.disclaimer+'</p></div></form>');
